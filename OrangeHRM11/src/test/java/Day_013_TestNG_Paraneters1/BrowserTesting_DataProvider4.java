...
public class BrowserTesting_DataProvider4
{
	...
	BrowserTesting_DataProvider4 BT;
	
	public void BrowserTesting_DataProvider4(WebDriver driver1)
	{
		this.driver=driver1;
...
public static Object[][] Authentication1() throws Exception {
	...
	public void Test3(String TestURL,String UserName,String Password,
		...
		//BT = new BrowserTesting_DataProvider4();
		//BT.BrowserTesting_DataProvider4(driver);
	...
	public void enter_login_details(String UserName,String Password) throws Exception {
		...
		R1.TakeScreenShotAuto(BrowserTesting_DataProvider4.driver,"UserName Entered","Pass");
